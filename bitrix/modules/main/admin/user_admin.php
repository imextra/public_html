...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if($USER->CanDoOperation('edit_php'))
	{
		...
		$arActions[] = array("ICON"=>"", "TEXT"=>GetMessage("MAIN_ADMIN_AUTH"), "TITLE"=>GetMessage("MAIN_ADMIN_AUTH_TITLE"), "ACTION"=>$lAdmin->ActionRedirect("user_admin.php?ID=".$f_ID."&action=authorize&".bitrix_sessid_get()));
	}
