...
class CAdminFileDialog
{
	...
	{
		global $USER;
		$bCloudsBrowse = is_object($USER) && $USER->CanDoOperation("clouds_browse");
	...
	<td class= "bxfd-cntrl-cell">
		<div id="__bx_fd_top_controls_container">
			<table class="bx-fd-top-contr-tbl">
				<tr>
					<?if (count($arSites) > 1):?>
						<td style="width:5% !important; padding: 0px 4px 0px 5px !important;">
					...
					<?endif;?>
					<td style="width:90% !important; padding: 0px 2px 0px 2px !important;">
